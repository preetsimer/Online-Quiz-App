...
client = MongoClient("mongodb://admin:admin12345@ds215093.mlab.com:15093/trivia_users")
db = client['trivia_users']
users = db.users
...
def index():
	...
	if request.method == 'POST':
		...
		if search:
			msg = 'Username already exists. Please Login to start Quiz'
		else:
...
def result():
	...
	return render_template('result.html',count=count,given_ans=given_ans,correct_ans=correct_ans,div_placeholder=Markup(p))
